...
class unet_pCT_multi_att_dsv_25D_convZ(nn.Module):
    ...
    def __init__(self, feature_scale=4, n_classes=2, is_deconv=True, in_channels=4, input_nz = 5,
        ...
        super(unet_pCT_multi_att_dsv_25D_convZ, self).__init__()
        ...
        # Conv along z
        self.convZ = nn.Conv3d(n_classes, n_classes, kernel_size=(1, 1, input_nz))
    ...
    def forward(self, inputs):
        ...
        # convolve to reduce Z dimension
        convZ = self.convZ(final)
