...
class unet_pCT_additive_bayesian_multi_att_dsv_3D(nn.Module):
    ...
    def __init__(self, feature_scale=4, n_classes=2, is_deconv=True, in_channels=4, prior_information_channels=0,
        ...
        # upsampling
        self.up_concat4 = UnetUp3_CT(filters[4], filters[3], is_batchnorm, conv_bloc_class=conv_bloc_class)
        self.up_concat3 = UnetUp3_CT(filters[3], filters[2], is_batchnorm, conv_bloc_class=conv_bloc_class)
        self.up_concat2 = UnetUp3_CT(filters[2], filters[1], is_batchnorm, conv_bloc_class=conv_bloc_class)
        self.up_concat1 = UnetUp3_CT(filters[1], filters[0], is_batchnorm, conv_bloc_class=conv_bloc_class)
